...
public class PortalClienteController {
    ...
    /** Inyecta las capas de aplicacion necesarias para el dashboard. */
    public PortalClienteController(ClienteService clienteService,
    ...
    public String mostrarDashboard(@PathVariable Integer id, Model model) {
        ...
        // Las reservas activas e historicas pertenecen al comportamiento del agregado Cliente.
